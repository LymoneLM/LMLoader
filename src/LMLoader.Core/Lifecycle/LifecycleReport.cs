...
{
	/// <summary>模组程序集加载进共享上下文(D1)。</summary>
	AssemblyLoad,

	/// <summary>反射实例化模块类型并注入上下文(D3)。</summary>
	Instantiation,
...
/// <summary>单个模块的运行结果(D7:单点失败不放大,一切可诊断)。</summary>
public sealed class ModuleRunResult
{
	...
	/// <summary>PostLoad 是否已执行(仅对 PreLoad/Load 成功者执行,D7)。</summary>
	...
	/// <summary>首个异常(hook 边界捕获,不外抛,D7)。</summary>
...
public sealed class LifecycleReport
{
	...
	/// <summary>strict 模式(D7 预留开关)因失败中止。</summary>
